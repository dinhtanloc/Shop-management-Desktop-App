...
import random as rd
import datetime
start_date = datetime.date(2023, 1, 1)  # ví dụ với ngày bắt đầu là 01/01/2022
end_date = datetime.date(2023, 11, 8)   # ví dụ với ngày kết thúc là 10/01/2022

start_time = datetime.time(10, 0)  # 9 giờ sáng
end_time = datetime.time(16, 0)  # 9 giờ tối
...
for i in range((end_date - start_date).days + 1):
    ...
    while current_datetime < end_datetime:
        ...
        # Khoảng thời gian ngẫu nhiên từ 30 phút đến 2 giờ
        random_minutes = rd.randint(30, 120)
        current_datetime += datetime.timedelta(minutes=random_minutes)
...
data_saleperson=[rd.choice(['Loc Dinh','Loc Dinh','Loc Dinh','Tuan Anh','Tuan Anh','Loc Dinh','Tuan Anh']) for i in range(x)]
# for i in range(x):
